...
import { ActorUser } from '../../../infrastructure/authentication';
...
import { ValidationFailedException } from '../../../infrastructure/validation';
import { ValidationErrorCodes } from '../../exceptions';
...
export class UsuarioService {
  ...
  async usuarioFindById(actorContext: ActorContext, dto: IUsuarioFindByIdInput, options?: FindOneOptions<UsuarioDbEntity>) {
    ...
    return actorContext.readResource(IAppResourceKey.USUARIO, usuario);
  }
  ...
  async getUsuarioStrictGenericField<K extends keyof UsuarioDbEntity>(
    ...
    await actorContext.ensurePermission(IAppResourceKey.USUARIO, IAuthorizationAction.READ, usuario, [field]);
  ...
  async usuarioCreate(actorContext: ActorContext, dto: IUsuarioCreateInput) {
    ...
    await actorContext.ensurePermission(IAppResourceKey.USUARIO, IAuthorizationAction.CREATE, usuario);
  ...
  async usuarioUpdate(actorContext: ActorContext, dto: IUsuarioUpdateInput) {
    ...
    await actorContext.ensurePermission(IAppResourceKey.USUARIO, IAuthorizationAction.UPDATE, updatedUsuario);
  ...
  async usuarioDelete(actorContext: ActorContext, dto: IUsuarioDeleteInput) {
    ...
    await actorContext.ensurePermission(IAppResourceKey.USUARIO, IAuthorizationAction.DELETE, usuario);
