...
import { RequestUserSSOHttp } from '@sisgea/nest-sso/dist/infrastructure/decorators/http';
...
export const ResolveActorContext = (options?: any) => RequestUserSSOHttp(options, ResolveActorContextPipe);
